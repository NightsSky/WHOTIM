...
//        observer=null;
    ...
    private void updateHeaderHeight(float delta) {
        ...
        if (isRefresh && !mPullRefreshing) { // 未处于刷新状态，更新箭头
            Log.d("me", recyclerViewHeader.getVisiableHeight() + "   " + mHeaderViewHeight);
            if (recyclerViewHeader.getVisiableHeight()-mHeaderViewHeight > mHeaderViewHeight) {
    ...
    private void resetHeaderHeight() {
        ...
        Log.d("me", "height" + height + "finalHeight - height" + (finalHeight - height));
...
//        }
        if (mScroller != null && mScroller.computeScrollOffset()) {
            if (mScrollBack == SCROLLBACK_HEADER) {
                recyclerViewHeader.setVisiableHeight(mScroller.getCurrY()+mHeaderViewHeight);
            } else {
        ...
        recyclerViewHeader.getViewTreeObserver().addOnGlobalLayoutListener(
                new ViewTreeObserver.OnGlobalLayoutListener() {
                    ...
                    public void onGlobalLayout() {
                        mHeaderViewHeight = recyclerViewHeader.getHeaderHeight();
                        getViewTreeObserver()
