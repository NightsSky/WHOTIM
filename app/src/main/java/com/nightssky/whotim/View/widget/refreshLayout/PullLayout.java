package com.nightssky.whotim.View.widget.refreshLayout;
...
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.DEFAULT;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.DOWN_AFTER;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.DOWN_BEFORE;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.LOADMORE_CANCEL_SCROLLING;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.LOADMORE_DOING;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.LOADMORE_SCROLLING;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.REFRESH_CANCEL_SCROLLING;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.REFRESH_DOING;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.REFRESH_SCROLLING;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.UP_AFTER;
import static com.nightssky.whotim.View.widget.refreshLayout.PullStatus.UP_BEFORE;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_MOVE: {
                // 计算本次滑动的Y轴增量(距离)
                int dy = y - lastYMove;
                Log.d("msg","dy=" + dy + "\tgetScrollY=" + getScrollY());
